...
# efibootmgr command:
#efibootmgr --create --disk /dev/sda --part 1 --label "Arch Linux -IPv6" --loader /vmlinuz-linux --unicode 'root=/dev/sda2 rw initrd=/intel-ucode.img initrd=/initramfs-linux.img ipv6.disable=1'
...
alias plugdp='xrandr --output HDMI-1 --right-of eDP-1 --auto && . ~/.fehbg'
alias switchdp='xrandr --output eDP-1 --off && xrandr --output HDMI-1 --auto && . ~/.fehbg'
alias unplug='xrandr --output VGA-1 --off; xrandr --output HDMI-1 --off; xrandr --output eDP-1 auto; . ~/.fehbg'
