...
alias streamrip-pip-install='uv pip install git+https://github.com/nathom/streamrip.git@dev'
alias yt-dlp-pip-install='uv pip install -U --pre "yt-dlp[default,curl-cffi]"'
alias yt-dlp-1080avc='yt-dlp --embed-metadata --embed-subs -f "(bv*[height<=?1080][vcodec~='\''^(avc|h264)'\'']+ba)"'
...
alias yt-dlp-metadata-subs='yt-dlp --embed-metadata --embed-subs'
