...
tpaset "libinput Click Method Enabled" 0, 1
tpaset "libinput Middle Emulation Enabled" 1
tpaset "libinput Disable While Typing Enabled" 1
...
tpaset "libinput Scroll Method Enabled" 1, 0, 0
tpaset "libinput Natural Scrolling Enabled" 0
tpaset "libinput High Resolution Wheel Scroll Enabled" 1
